    ...
    <div className="space-y-8">
      ...
      <div className="bg-terminal-panel border border-terminal-border rounded-lg p-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-white text-sm font-medium">Web Search</h3>
          <span className="text-green-400 text-xs flex items-center gap-1">
            <Check className="w-3 h-3" /> Ready
          </span>
          <HelpTooltip content="AI can search the web for historical market events. Ask questions like 'What happened to AAPL in 2014?' and AI will search and summarize results." />
        </div>

        <div className="p-3 bg-terminal-up/10 border border-terminal-up/30 rounded text-xs text-terminal-up mb-3">
          Web search works automatically - no setup needed!
        </div>
